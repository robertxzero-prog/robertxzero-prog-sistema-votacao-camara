        ...
        <section className="w-full rounded-[28px] border border-slate-200 bg-white p-7 shadow-xl xl:p-8">
          {loadingStatus ? (
            ...
            <div className="flex flex-col justify-start">
              <h2 className="text-[44px] font-black leading-[0.95] text-slate-900 lg:text-[48px] xl:text-[54px]">
                {modoRecuperacao ? "Recuperar senha" : "Acesso administrativo"}
              </h2>
              <p className="mt-2 text-[20px] text-slate-600 xl:text-[22px]">
                {modoRecuperacao
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      <button
                        type="submit"
                        disabled={carregando}
                        className="rounded-2xl bg-slate-800 px-4 py-2.5 text-base font-semibold text-white hover:bg-slate-900 disabled:bg-slate-400"
                      >
                    ...
                    >
                      <input
                        ...
                        className="rounded-2xl border border-slate-300 bg-slate-100 px-4 py-2.5 text-lg text-slate-800 placeholder:text-slate-500 focus:border-blue-500 focus:outline-none"
                      ...
                      <button
                        type="submit"
                        disabled={carregando}
                        className="rounded-2xl bg-blue-600 px-4 py-2.5 text-lg font-semibold text-white hover:bg-blue-700 disabled:bg-blue-300"
                      >
